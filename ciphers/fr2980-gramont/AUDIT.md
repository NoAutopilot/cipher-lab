...
- READ row 68, 24 Sept 2026: Mignet, "Rivalité de Charles-Quint et de François Ier" (the instalment 'Guerre et négociations après la captivité de Clément VII; défis de Charles-Quint et de François Ier à un combat singulier'), *Revue des Deux Mondes*, 2e période, 68/1 (1er mars 1867), pp. 99-136, https://www.jstor.org/stable/44728935 (open access). In-viewer search: "Gramont" 2 hits, "Tarbes" 5, "Villandry" 0, "1530" 0. Every Gramont or Tarbes passage belongs to 1527: Sir Francis Poyntz and Gabriel de Gramont, bishop of Tarbes, received by Charles V at Valladolid on 4 July 1527 (p. 110); a letter of the bishop from Burgos to chancellor Duprat on the emperor's mistrust, quoted in a footnote of the Burgos-negotiation pages (between pp. 114 and 118, no shelfmark given); the joint French and English summons to the emperor and the "secondes instructions" to Gramont as ambassador extraordinary of 11 November 1527 (Archives impériales carton J, Mss. Dupuy 495 f. 26; footnote at pp. 122-123). The instalment ends in 1528. It neither prints, calendars nor discusses the 20 May [1530] letter to Villandry, fr. 2980 or any cipher; the correspondents it names are Duprat, Poyntz and Charles V.
