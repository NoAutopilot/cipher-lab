...
Recorded by the JSTOR runner on the owner's machine (logged-in JSTOR account, built-in browser, online page viewer only, in-viewer search, no PDF). No class is changed here; the verifier moves it.

- READ row 70, 24 Sept 2026: Martin Philippson, "Allemagne" (Bulletin historique, histoire moderne et contemporaine, année 1906), *Revue Historique* 97/1 (1908), pp. 144-168, https://www.jstor.org/stable/40941620 (read online). In-viewer search: "Oranien" 3 hits, "Saxe" 12, "Briefwechsel" 3, "Anna" 0 in the viewer's index (the page text carries it), "Chiffre" 0 ("chiffre" only as a numeral). The Orange hits are seventeenth-century: Ludwig Keller on the Hohenzollern and the Orange-Nassau, and Arthur Kleinschmidt's *Amalie von Oranien* (pp. 152-153). The Saxony hits: a notice of Konrad Sturmhövel, *Kurfürstin Anna von Sachsen* (Biographien bedeutender Frauen V, Leipzig 1905), which Philippson calls a popularising biography of the Electress Anna (1532-1585), wife of the Elector August, painted as a fanatical Lutheran who confirmed her husband in the persecution of the crypto-Calvinists (pp. 148-149); the peasants of Saxe-Altenburg (Brandt); Maurice of Saxony's revolt (Hecker). The "Briefwechsel" hits are nineteenth-century (Friedrich Wilhelm IV and Camphausen, p. 164). No edition of the Orange-Saxony letters is reviewed, and nothing prints, calendars or discusses the 1561-64 letters or their cipher.
