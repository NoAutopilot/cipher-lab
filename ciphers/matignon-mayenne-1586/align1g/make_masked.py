#!/usr/bin/env python3
"""bMAT1G (copied from align1e/make_masked.py; reads f78_corrected_stream.txt + Bourdeau f79_cipher.txt; ?-signs shown as <?>): build masked copies of the f.78v/f.79r cipher streams (Bourdeau's transcriptions,
