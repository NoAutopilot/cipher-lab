...
| JSTOR | done 26 Sept 2026 | 2 rows in `JSTOR-QUEUE.tsv` (Szembek + cipher + Kórnik; Brâncoveanu/Serban + impostor/detractor + Burgundus) | no relevant hit on either query; cannot move an N0 |
