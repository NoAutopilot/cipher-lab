...
- **Archive route (English, no key needed):** Stepney's own letter-books at TNA, SP 105 (Archives of British
  Legations; his Vienna volumes are around SP 105/60-66), normally hold copies of his out-letters in clear. A copy
  of the entry for 23 March 1702 would give the plaintext directly. Second route: the Stepney Papers, BL Add MSS
  7058-7078, which reportedly include his cipher keys, once the British Library is producing copies again. Third:
  TNA SP 106, the office's cipher templates. Bourdeau's transcription of the 24 groups from the Yale images is in
  cyphersolver/stepney/ciphertext.txt, with one correction to Tomokiyo (413, not 412).
