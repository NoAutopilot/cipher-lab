...
checking which of f.28's two blind-pass candidates it confirms) to recon_0028_full/ciphertext_draft.tsv.
...
def main():
    settled = {}
    for fn in ('manual_witness_settled.tsv', 'manual_witness_settled2.tsv'):
