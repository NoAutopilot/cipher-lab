#!/usr/bin/env python3
"""Build ciphertext_f57v.tsv (line,pos,code,marks,grade) exactly as ciphertext_f55r.tsv: every
...
by recon_box_f57v/settled.tsv (2-of-3 majority with pass C, or a reasoned arbitration on a 3-way split)."""
import csv
...
settled = load('recon_box_f57v/settled.tsv')
...
with open('ciphertext_f57v.tsv', 'w') as f:
...
print(f'{len(out)} rows -> ciphertext_f57v.tsv (AB {n_ab}, settled {n_settled})')
