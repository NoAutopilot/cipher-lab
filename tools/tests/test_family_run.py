...
def test_family_run():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        try:
            ...
            dec_path = os.path.join(fdir, "families", "masc-1.txt")
            assert os.path.exists(dec_path), log
            ...
            vdec_path = os.path.join(ROOT, "ciphers", "synthetic-vig-test", "families", "periodic_vigenere-1.txt")
