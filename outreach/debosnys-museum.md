to: research@adkhistorymuseum.org (Essex County Historical Society & Adirondack History Museum, Elizabethtown NY -- read 26 Sept 2026 by OUT-CHECK on the museum's own research page, https://www.adkhistorymuseum.org/research; replaces echs@adkhistorycenter.org, whose domain no longer resolves)
voice: rewritten 26 Sept 2026 17:46 UTC by parent 7i in first-person plain voice (owner's ask, 17:45 UTC); facts as checked 17:37; the body of record is outreach/mailbox/debosnys-museum.json; OUT-CHECK-2 re-check pending, not sendable until its checked: line lands
...
Not sent. The owner sends it and records the date and reply here.
