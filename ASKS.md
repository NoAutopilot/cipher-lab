...
| 2 | 20 Sept | cipher-lab | archive.org login rejected; `IA_USER` is not an email | Rotate the password, set `IA_USER` to the account email, update both variables | Ryan | open |
