...
The parent orchestrator runs the hourly check-in (trigger trig_01HcDMU12TuKDS8bKnsfczHe (30-minute cadence while lanes run), self-bound, re-armed by send_later at every firing; its prompt is the
