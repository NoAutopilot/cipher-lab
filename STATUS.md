...
The parent orchestrator runs the hourly check-in (trigger trig_013XdhzjiZSFCQUMgwFZN6KK (30-minute cadence while lanes run), self-bound, re-armed by send_later at every firing; its prompt is the
