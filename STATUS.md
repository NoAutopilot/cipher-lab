...
| Wellington to Maitland, 1812 | ciphers/wellington-maitland-1812 | Transcribed 19 Sept 2026. Dictionary search: 57 editions tested, none matches (DICTIONARY.md) | Before 23 Sept: email Spink asking whether lot 1184 includes a pocket dictionary; run the HathiTrust full-view search from a browser (DICTIONARY.md section 6) | You |
