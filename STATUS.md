...
- GOLD-KAL4 (Sonnet, $6 / 80 min from about 02:38, box about 03:58): the four CONTROL BELOW GATE pairings (ru s1s-A, ru s3-B, pl-A, lt-A) at restarts 20 seeds 5 plus lt-B, then the seven-language Latin sweep at convention B if the 80 pct rule allows; brief `2026-09-26-lane-gold-c6-kaliningrad-restarts-and-sweep.md`. KAL3 (Polish) done 02:18, ledgered D-, archived.
