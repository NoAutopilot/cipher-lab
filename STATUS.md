...
| G3, Gallica manuscripts (successor to G2, 12:02 UTC) | session_01WVnAc4cU7RQjEoBfbkuGrG | G2's successor priorities only; DC8/DC9, natives for the recovery lane, one more scout family; pauses if only owner orders remain | the only lane on gallica.bnf.fr and archivesetmanuscrits, two fetchers at most |
