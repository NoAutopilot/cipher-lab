...
2. Read `LESSONS.md`, `LEDGER.md` (one row per worker, outcome and cost), `.claude/briefs/` (role templates, edited by the weekly retrospective) before writing any solver. The short version: search for a printed solution,
