...
|---|---|---|---|---|---|
| DECODE_USER | DECODE (de-crypt.org) login, plain user name | tools/decode_browser_login.js | owner, 20 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| DECODE_PASS | DECODE password | tools/decode_browser_login.js | owner, 20 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| IA_USER | Internet Archive account (email) for lending | tools/ia_borrow.py | owner, 20 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| IA_PASS | Internet Archive password | tools/ia_borrow.py | owner, 20 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| GOOGLE_BOOKS_KEY | Google Books API key (`&key=`, with `&country=US`) | tools/print_check.py | owner, 20 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| JSTOR_USER | JSTOR (JPASS), owner's machine only | tools/jstor_runner_brief.md | owner, 20 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| JSTOR_PASS | JSTOR password, owner's machine only | tools/jstor_runner_brief.md | owner, 20 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| OPENALEX_KEY | OpenAlex API key (Bearer header) | tools/print_check.py | owner, 24 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| S2_KEY | Semantic Scholar API key (x-api-key header) | tools/print_check.py | owner, 24 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| REDDIT_CLIENT_ID | Reddit API app id (client_credentials grant) | .claude/briefs/runs/2026-09-24-reddit-fetch-*.md | owner, 24 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| REDDIT_CLIENT_SECRET | Reddit API app secret | .claude/briefs/runs/2026-09-24-reddit-fetch-*.md | owner, 24 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| EUROPEANA_API_KEY | Europeana Search API (`wskey=`) | scouts (QUEUE.md) | ASKS 47, 25 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| DPLA_API_KEY | Digital Public Library of America (`api_key=`) | scouts | ASKS 47, 25 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| AWS_ACCESS_KEY_ID | undocumented (document before use): ASKS 62 asks which service and job | none yet | found by probe, 25 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
| AWS_SECRET_ACCESS_KEY | undocumented (document before use): ASKS 62 | none yet | found by probe, 25 Sept 2026 | set | ytbiz@2026-09-25T22:44, owner@2026-09-26T16:47 |
