...
| 5 | 19 | Kaliningrad (Baltiysk) bottle post | Soviet era, found 2015 | ru-latin/pl/lt/de | 2 sheets, 37 signs incl. apostrophes, IC 0.054 | Cipherbrain post 19 images; Russian blog transcription; not on disk | open (58 comments, no solution) **LANE B2 25 Sept 2026: test 1 Ernst transcript matches both images 26/26 lines; N=978 K=36 IC 0.0657 vs transliterated Russian 0.056 / German 0.072: not informative; ciphertext on disk (ciphers/kaliningrad-2015/).** **LANE GOLD3 26 Sept 2026 (GOLD-KAL1, reserve): Synodal-chapter crib claim (Frank 2021) tested by word-pattern solver, control 0.997-0.999 vs target words matched 0.118/0.123 against a shuffle null max 0.096/0.080 (no flag); German light homophonic K36 control 0.982 vs target judge FAIL: control-backed negative. Russian Synodal corpus tools/data/ru19 on disk.** **GOLD-CONS4 26 Sept 00:52: transliterated Russian from ru19 under three schemes at N 978 gives IC 0.0547-0.0611 (K 34-37), bracketing the target's 0.0657 at K 36, so the earlier IC gap was a scheme mismatch, not a language exclusion; Russian substitution never run -- GOLD-KAL2 (Russian under transliteration) and GOLD-KAL3 (Polish) briefed.** **GOLD-KAL2 26 Sept 01:31: Russian homophonic under two transliteration schemes at convention B (K 28): controls 0.999/0.997 vs target judge FAIL -1.706/-1.729, control-backed negatives; two further scheme/convention pairings CONTROL BELOW GATE (0.733, 0.677), untested; periodic IC flat. **GOLD-KAL3 26 Sept 02:18: Polish homophonic at convention B (K 28, pl19 corpus): control 0.996 vs target judge FAIL -1.971, control-backed negative; Polish and Lithuanian at convention A CONTROL BELOW GATE on one collapsed seed each (a restarts question, GOLD-KAL4). Corpora tools/data/pl19 and tools/data/lt on disk.** **GOLD-KAL4 26 Sept 03:08: at restarts 20 the Russian s1s-A, Russian s3-B and Polish-A controls read 0.908/0.955/0.977 and every target judge-FAILed; Dutch, Danish, English, French, Italian, Spanish at convention B: controls 0.908-0.998, every target FAIL; Lithuanian-A (0.827) and Portuguese-B (0.555) CONTROL BELOW GATE. Every language candidate with a corpus is now a control-backed negative for simple/light-homophonic substitution; periodic IC flat; transposition excluded by the apostrophe count. Status open (not closed-negative: running-key and non-periodic polyalphabetic families untested). LANE GOLD idle-standing.** | nobody found |
