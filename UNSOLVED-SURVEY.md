...
| 21 | 24 | Erba murder letter | 2006 | it | one letter | not fetched | open | nobody spec: specs/erba-2006.json |
...
| 24 | 41 | Blitz ciphers | found "1940s", published 2011 | ? | 3 of 8 pages published | Pelling's site; not on disk | open; suspected modern hoax | Pelling spec: specs/blitz-ciphers.json |
...
| 26 | 21 | YOG'TZE (Guenther Stoll) | Oct 1984 | de | 6 characters | on disk | open; below any unicity | nobody spec: specs/yogtze-1984.json |
| 27 | 38 | Sufi fiddle inscription | ? | ? | unidentified script | no published transcription | open; provenance rests on a novel's afterword (Bourdeau) | nobody spec: specs/sufi-fiddle.json |
| 28 | 11 | Untersberg code | legend | ? | one alleged sheet | none | open; legend, no primary source | nobody spec: specs/untersberg-code.json (25 Sept 2026: a real primary source, Salzburg Museum Hs. 2398, and transcription found -- this row's wording may be stale, see spec) |
| 29 | 36 | Fair Game end-credits letters | 2010 | en | yellow letters in credits | film | open; may not be a code | nobody spec: specs/fair-game-2010.json |
| 30 | 33 | Censorship-manual steganograms | WW2 | en | two pictures | manual scans | open | nobody spec: specs/censorship-manual-stego.json |
