...
| 8 | 5520+5521 | 1526.06.05 | Venecia | A-37, f.363-371 (orig+dup) | Alonso Sánchez → Charles V | "...por estar en cifra y no hallarse a continuación el texto descifrado, no se puede precisar cuáles serían [los asuntos]" — cataloguer could not even summarize the letter | **Ko.9** | new, not in ciphers/ or held pool | NOT CALENDARED -- CSP vol.III pt.1's only 5 Jun 1526 entry is Lope de Soria writing from Genoa, referencing "Sanchez' despatches" from Venice, not a Sanchez letter itself; no Venice-dated 5 Jun entry found |
| 9 | 5538 | 1526.06.13 | Venecia | A-37, f.419-422 | Alonso Sánchez → Charles V | "...no se hallan descifrados." | **Ko.9** | new; adjacent D crib (inv. 5537) is for Lope de Soria, not this correspondent | IN PRINT -- CSP vol.III pt.1 No.459, "Alonso Sanchez, Imperial Ambassador in Venice, to the Emperor," Venice, 13 Jun 1526, shelfmark "M. Re. Ac. d. Hist. Salazar, A.37, ff.419-22" (exact match), (Cipher:)/(Common writing:) alternating, "Spanish. Original. Contemporary deciphering. pp.10" |
...
| 11 | 5543 | 1526.06.18 | Venecia | A-37, f.438-440 | Alonso Sánchez → Charles V | "...cuyo texto descifrado no existe a continuación." | **Ko.9** | new; "Publicada en parte por Rodríguez Villa, ob. cit. pp.133-134" — worth checking that print edition | NOT CALENDARED -- CSP vol.III pt.1 checked for 18 Jun 1526: the entries under that date are Jonglet/Simon de Tassis/Marquis del Guasto, not Sanchez; shelfmark f.438-440 not found anywhere in the volume |
| 12 | 5545 | 1526.06.19 | Venecia | A-37, f.444-447 | Alonso Sánchez → Charles V | "...cuyo texto descifrado no existe a continuación. Es traslado de otra embiada..." | **Ko.9** | new | NOT CALENDARED -- CSP vol.III pt.1 checked for 19 Jun 1526: the calendar jumps from 18 to 20 June with no Sanchez entry between; shelfmark f.444-447 not found anywhere in the volume |
| 13 | 6120 | 1527.07.20 | Venecia | A-41, f.27-28 | Alonso Sánchez → Charles V | "...que no se encuentran descifrados a continuación." | **Ko.9** | new | IN PRINT, flagged -- CSP III pt.2, "Alonso Sanchez ... to the Emperor," Venice, 20 Jul 1527, shelfmark "Salazar, A.41, f.29" (RAH gives f.27-28, off by 1-2 folios); footer "Spanish. Original. pp.4" carries no (Cipher:) marking at all, unlike rows 9/14/17/18 below -- date/sender/place match exactly but the cipher-passage status doesn't square with the RAH's own note; report as a probable match, not a settled one |
| 14 | **6122** | 1527.07.24 | Milán | A-41, f.33-37 | Marino Caracciolo → Charles V | "...con algunos párrafos en cifra que no se hallan descifrados a continuación." | **Ko.8** (p.338/348, Italian) | **new, strongest fresh candidate**: genuinely undeciphered (unlike S3/inv.5541, same correspondent, interlinear-deciphered elsewhere in this collection — direct proof the key family is provable) | IN PRINT -- CSP III pt.2 No.122, "Prothonotary Caracciolo to the Emperor," Milan, 24 Jul 1527, (Cipher:) paragraph given in English, "Italian. Holograph partly in cipher. pp.9" (shelfmark column OCR-garbled/unreadable but sender+date+place match exactly); **reverses this row's own #1 ranking below** |
| 15 | 6124 | 1527.07.27 | Venecia | A-41, f.41-43 | Alonso Sánchez → Charles V | "...cuyo texto descifrado no existe a continuación." | **Ko.9** | new; same-tomo D crib exists (inv. 6191, "Texto descifrado de las cartas 6188 y 6189", Alonso Sánchez, A-41) — not page-adjacent but same correspondent/legajo | IN PRINT, flagged -- CSP III pt.2, "Alonso Sanchez" ... to the Emperor (and to Soria), Venice, 27 Jul 1527, footer "Spanish. Original. pp.5" carries no (Cipher:) marking -- same caveat as row 13 (inv.6120) |
| 16 | 6192 | Sin data (1527) | — | A-41, f.193-195 | Alonso Sánchez → **Martín de Ugarte** (not Charles V) | "Original, cuyo texto no se halla descifrado a continuación." | Ko.9, **unconfirmed for this addressee** — ciphers were often per correspondent-pair, not per-sender | new; flag uncertainty before assuming Ko.9 applies | NOT CALENDARED -- "Ugarte" has zero hits anywhere in CSP vol.III pt.1 or pt.2 (both fetched whole, grepped in full) |
| 17 | 6331 | 1528.01.19 | Venecia | A-42, f.70-71 | Alonso Sánchez → Charles V | "...que no se encuentran descifrados a continuación." | **Ko.9** | new; "Publicada, en parte, por Rodríguez Villa... página 362" | IN PRINT -- CSP III pt.2 No.292, "Alonso Sanchez, Imperial Ambassador at Venice, to the Emperor," Venice, 19 Jan 1528, several (Cipher:) sections, "Spanish. Original partly in cipher. Contemporary deciphering on separate sheet (f.72). pp.8" (RAH gives A-42 f.70-71 -- decipherment sheet at f.72 fits the Indice's own pattern of filing a decipherment as the very next folio) |
...
| 25 | 16231 | 1661.09.11 | Badajoz | A-107, f.193 | Juan José de Austria → Luis Méndez de Haro | "Original, en cifra. No se halla el texto descifrado a continuación." | none known — same addressee (Haro) as S5's crib but a different decade/front (Badajoz/Portugal war, 1661, vs Naples 1648); same-key assumption unconfirmed | new | no CSP coverage (1661) -- not run |
...
Row 14 (inv. 6122, Marino Caracciolo → the Emperor, Milan, 24 Jul 1527) — called "the strongest single new
...
known from NX2-GATE2, the other six new this session), each checked page-by-page in its date window with a
