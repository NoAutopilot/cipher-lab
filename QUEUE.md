...
| 5 | 4670 | 1524.12.17 | Venecia | A-33, f.72-74 | Alonso Sánchez → Charles V | "...no están descifrados a continuación." | **Ko.9** | **held** — rah-salazar-soria-sanchez-1524-28 item 4 | NOT CALENDARED (NX2-GATE2, held item 4) -- stays open |
...
| 8 | 5520+5521 | 1526.06.05 | Venecia | A-37, f.363-371 (orig+dup) | Alonso Sánchez → Charles V | "...por estar en cifra y no hallarse a continuación el texto descifrado, no se puede precisar cuáles serían [los asuntos]" — cataloguer could not even summarize the letter | **Ko.9** | not on file before this sweep, not in ciphers/ or held pool | NOT CALENDARED -- CSP vol.III pt.1's only 5 Jun 1526 entry is Lope de Soria writing from Genoa, referencing "Sanchez' despatches" from Venice, not a Sanchez letter itself; no Venice-dated 5 Jun entry found |
...
| 10 | 5540 | 1526.06.16 | Génova | A-37, f.428-429 | Lope de Soria → Charles V | "...sin descifrar." | **Ko.6**/Ko.16 | **held** — item 2; adjacent Caracciolo D pair (5541/5542) resolves S3, see above | NOT CALENDARED (NX2-GATE2, held item 2) -- stays open |
